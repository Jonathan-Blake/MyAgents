...
public class TournamentObserver extends Observer implements Runnable {
	 ...
	 */
	private boolean ccd;
	private List<String> ccdedPlayers = new LinkedList<>();
...
//		this.diplomacyMonitor.dispose();
	...
	public void handleSMR(String[] message) {
		...
		FileIO.appendToFile(this.gameResultsFile, "game " + this.gameNumber + ": " + System.lineSeparator() + gameResult);
	...
	public List<GameResult> getGameResults() {
		return new ArrayList<>(this.tournamentResult.gameResults);
	}
	...
	public String getCCDedPlayers() {
		return this.ccdedPlayers.stream().distinct().collect(Collectors.joining(", "));
	}
}
